...
╰━━━━━━〔 *👹 ${vs}* 〕━━━━━━⬣
`.trim()
await conn.sendHydrated(m.chat, str, wm, pp, md, '𝗚𝗜𝗔𝗡-𝗕𝗢𝗧', null, null, [
...
{title: "✅ 𝘾𝙪𝙚𝙣𝙩𝙖𝙨 𝙊𝙛𝙞𝙘𝙞𝙖𝙡𝙚𝙨 ✅", description: null, rowId: `${usedPrefix}cuentasgb`},  
...
{title: "➥🔊 brother", description: null, rowId: `brother`},
{title: "➥🔊 nosotros", description: null, rowId: `nosotros`},
{title: "➥🔊 ayer", description: null, rowId: `ayer`},
{title: "➥🔊 llorando", description: null, rowId: `llorando`},
{title: "➥🔊 esa cruz", description: null, rowId: `esa cruz`},
...
{title: "➥🔊 alarma anuel", description: null, rowId: `alarma`},
...
{title: "➥🔊 poto", description: null, rowId: 
`poto`},
...
const listMessage = {
text: `𝙂𝙄𝘼𝙉-𝘽𝙊𝙏 | 𝘼𝙐𝘿𝙄𝙊𝙎`,
footer: `*╭━━━〔 𝙈𝙀𝙉𝙐 𝘿𝙄𝙉𝘼𝙈𝙄𝘾𝙊 〕━━━⬣*
*┃ 𝑶𝒆 𝒔𝒐𝒏𝒔𝒐! 𝒂𝒒𝒖𝒊́ 𝒆𝒔𝒄𝒐𝒈𝒆 𝒍𝒐𝒔 𝒂𝒖𝒅𝒊𝒐𝒔 𝒙𝒅  
*╰━━━━━━━━━━━━━━━━━⬣*
${wm}`,
title: null,
