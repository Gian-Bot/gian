...
if (!args[0]) {
	...
	rows: [
{title: "დ 𝘐𝘕𝘝𝘌𝘕𝘛𝘈𝘙𝘐𝘖 1", rowId: usedPrefix + command + ' 1'},
{title: "დ 𝘐𝘕𝘝𝘌𝘕𝘛𝘈𝘙𝘐𝘖 2", rowId: usedPrefix + command + ' 2'},
{title: "დ 𝘐𝘕𝘝𝘌𝘕𝘛𝘈𝘙𝘐𝘖 3", rowId: usedPrefix + command + ' 3'},
{title: "დ 𝘐𝘕𝘝𝘌𝘕𝘛𝘈𝘙𝘐𝘖 4", rowId: usedPrefix + command + ' 4'}
]
},{
	title: comienzo + ' ❖ 𝗣𝗘𝗖𝗘𝗦 ❖ ' + fin,
	rows: [
{title: "ღ 𝘗𝘐𝘚𝘊𝘐𝘕𝘈 ", rowId: usedPrefix + command + ' invkolam'},
{title: "ღ 𝘈𝘊𝘜𝘈𝘙𝘐𝘖", rowId: usedPrefix + 'kolamikan'}
]}
]
...
┃ ╸╸╸╸╸╸╸╸╸╸╸╸╸╸
┃ 🐎 *Caballo* 
┃ *${kuda == 0 ? 'No tengo Mascota.' : '' || kuda == 1 ? 'Nivel | Level ✦ 1' : '' || kuda == 2 ? 'Nivel | Level ✦ 2' : '' || kuda == 3 ? 'Nivel | Level ✦ 3' : '' || kuda == 4 ? 'Nivel | Level ✦ 4' : '' || kuda == 5 ? 'Nivel | Level ✦ 5 ǁ MAX' : ''}*
┃ ╸╸╸╸╸╸╸╸╸╸╸╸╸╸
┃ 🦊 *Zorro*
┃ *${rubah == 0 ? 'No tengo Mascota.' : '' || rubah == 1 ? 'Nivel | Level ✦ 1' : '' || rubah == 2 ? 'Nivel | Level ✦ 2' : '' || rubah == 3 ? 'Nivel | Level ✦ 3' : '' || rubah == 4 ? 'Nivel | Level ✦ 4' : '' || rubah == 5 ? 'Nivel | Level ✦ 5 ǁ MAX' : ''}*
┃ ╸╸╸╸╸╸╸╸╸╸╸╸╸╸
┃ 🐈 *Gato* 
┃ *${kucing == 0 ? 'No tengo Mascota.' : '' || kucing == 1 ? 'Nivel | Level ✦ 1' : '' || kucing == 2 ? 'Nivel | Level ✦ 2' : '' || kucing == 3 ? 'Nivel | Level ✦ 3' : '' || kucing == 4 ? 'Nivel | Level ✦ 4' : '' || kucing == 5 ? 'Nivel | Level ✦ 5 ǁ MAX' : ''}*
┃ ╸╸╸╸╸╸╸╸╸╸╸╸╸╸
┃ 🐶 *Perro* 
┃ *${anjing == 0 ? 'No tengo Mascota.' : '' || anjing == 1 ? 'Nivel | Level ✦ 1' : '' || anjing == 2 ? 'Nivel | Level ✦ 2' : '' || anjing == 3 ? 'Nivel | Level ✦ 3' : '' || anjing == 4 ? 'Nivel | Level ✦ 4' : '' || anjing == 5 ? 'Nivel | Level ✦ 5 ǁ MAX' : ''}*
╰━━━━━━━━━⬣
...
[`𝘼𝙫𝙚𝙣𝙩𝙪𝙧𝙖𝙧 🏕️`, `${usedPrefix}adventure`],
...
let user = global.db.data.users[m.sender]
  ...
  const pets = Object.keys(inventory.pets).map(v => user[v] && `*${global.rpg.emoticon(v)} » ${user[v] >= inventory.pets[v] ? '*Nivel Máximo.*' : `Nivel : Level* \n*» ${user[v]}*\n`}`).filter(v => v).join('\n').trim()
...
`🤺 𝗥𝗘𝗖𝗢𝗠𝗣𝗘𝗡𝗦𝗔𝗦 𝗥𝗘𝗔𝗟𝗜𝗭𝗔𝗗𝗔𝗦 
${cooldowns}` : ''}
*✧ Calabozo » ${user.lastdungeon == 0 ? '✅': '❌'}*
*✧ minería » ${user.lastmining == 0 ? '✅': '❌'}*
...
*✧ Sacudir » ${user.lastngocok == 0 ? '✅': '❌'}*`.trim()
...
await conn.sendButton(m.chat, caption, wm, imgr + 'Inventario', [
[`𝘼𝙫𝙚𝙣𝙩𝙪𝙧𝙖𝙧 🏕️`, `${usedPrefix}adventure`],
...
*╭────━• ESTRATEGIAS*
*│🥼 Armadura : Armor:* 
*│➠ ${armor == 0 ? 'No tengo.' : '' || armor == 1 ? '✦ Armadura de Cuero' : '' || armor == 2 ? '✦ Armadura de Hierro' : '' || armor == 3 ? '✦ Armadura Mágicar' : '' || armor == 4 ? '✦ Armadura Robótica' : '' || armor == 5 ? 'Armadura Cyborg Estelar ǁ MAX' : ''}*
...
*│┈┈┈┈┈┈┈┈┈┈┈┈┈*
*│🎣 Caña de pescar* 
*│➠ ${pancing == 0 ? 'No tengo.' : '' || pancing == 1 ? 'Nivel | Level ✦ 1' : '' || pancing == 2 ? 'Nivel | Level ✦ 2' : '' || pancing == 3 ? 'Nivel | Level ✦ 3' : '' || pancing == 4 ? 'Nivel | Level ✦ 4' : '' || pancing == 5 ? 'Nivel | Level ✦ 5 ǁ MAX' : ''}*
*│🎣⇡ Durabilidad : Durability:* 
*│↸ ${fdurability}*
*│┈┈┈┈┈┈┈┈┈┈┈┈┈*
*│🏹 Arco*
*│➠ ${pancing == 0 ? 'No tengo.' : '' || pancing == 1 ? '✦ Arco de Poca Distancia || 1' : '' || pancing == 2 ? '✦ Flechas Mejoradas || 2' : '' || pancing == 3 ? '✦ Arco de última tecnología || 3' : '' || pancing == 4 ? '✦ Arco Explosivo || 4' : '' || pancing == 5 ? '✦ Arco Nuclear || 5' : ''}*
*│🏹⇡ Durabilidad* 
*│↸ ${bdurability}*
*╰─⋆─⋆─⋆─⋆─⋆─⋆─⋆─⋆─┄⸙*
...
*│🦐 Camarón » ${udang}* 
*│*
*│💬 Pescados » ${orca + udang + hiu + lobster + lumba + cumi + gurita + kepiting + paus + nila + bawal + ikan + lele + psepick + psenjata }*
*╰─⋆─⋆─⋆─⋆─⋆─⋆─⋆─⋆─┄⸙*
...
*│ ⚔️ Duelo :* ${lastduel > 0 ? '❌' : '✅'}
*│ 🛡️ Guerra :* ${lastwar > 0 ? '❌'  : '✅'}
*│ 🎃 Mazmorras :* ${lastdungeon > 0 ? '❌' : '✅'}
*│ 💱 Comercio :* ${lastdagang > 0 ? '❌'  : '✅'}
*│ 🧺 Jardinería :* ${lastberkebon > 0 ? '❌'  : '✅'}
*│ ⛏️ Minería :* ${lastmining > 0 ? '❌' : '✅'}
*│ 🎣 Pezca : Fishing :* ${lastfishing > 0 ? '❌'  : '✅'}
*│ 💰 Asistencia social :* ${lastbansos > 0 ? '❌' : '✅'}
*│*
*│ 🕐 Cada hora :* ${lasthourly > 0 ? '❌' : '✅'}
*│ 📦 Reclamar :* ${lastclaim > 0 ? '❌' : '✅'}
...
*│👹 Top Coins: ${usersmoney.indexOf(m.sender) + 1} / ${usersmoney.length}*
...
// let ftroli = { key: {participant : '0@s.whatsapp.net'}, message: { orderMessage: { itemCount: 2022, status: 1, surface: 1, message: bottime, orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }   
 await conn.sendButton(m.chat, str, wm, imgr + 'Inventario : Inventory', [[`${healt < 40 ? '❤️ 𝘾𝙐𝙍𝘼𝙍𝙈𝙀' : '𝘼𝙫𝙚𝙣𝙩𝙪𝙧𝙖𝙧 🏕️'}`, `${healt < 40 ? '.heal' : '.adventure'}`], ['🏪 𝙏𝙞𝙚𝙣𝙙𝙖', '.shop']], m, {quoted: fkontak})
...
┃🍱 *Caja para Mascota » ${pet}*
┃💐 *Caja de Jardinería » ${gardenboxs}*
╰━━━━━━━━━⬣
...
*DATOS DEL GANCHO*
*╭────────────────*
*│🔥 Gancho » ${pancingan == 0 ? 'No tengo.' : '' || pancingan == 1 ? 'Nivel | Level ✦ 1' : '' || pancingan == 2 ? 'Nivel | Level ✦ 2' : '' || pancingan == 3 ? 'Nivel | Level ✦ 3' : '' || pancingan == 4 ? 'Nivel | Level ✦ 4' : '' || pancingan == 5 ? 'Nivel | Level ✦ 5 ǁ MAX' : ''}*
*│ Poder del Gancho » ${pancingan == 0 ? 'No tengo.' : '' || pancingan > 0 && pancingan < 5 ? `Nivel : Level » ${pancingan} a Nivel ${pancingan + 1}\n*│Exp » ${_pancingan} -> ${pancingan *10000}*` : '' || pancingan == 5 ? 'Nivel | Level ✦ 5 ǁ MAX' : ''}*
*╰────────────────*
`.trim()
...
await conn.sendButton(m.chat, aineh, wm, imgr + 'Inventario', [
[`𝘼𝙫𝙚𝙣𝙩𝙪𝙧𝙖𝙧 🏕️`, `${usedPrefix}adventure`],
