...
${readMore}
*╭━〔 INFORMACIÓN DEL BOT 〕━⬣*
┃💫➺ _${usedPrefix}cuentasgb | cuentasgb_
┃💫➺ _${usedPrefix}gruposgb | grupos | groupgb_
┃💫➺ _${usedPrefix}donar | donate_
┃💫➺ _${usedPrefix}listagrupos | grouplist_
┃💫➺ _${usedPrefix}estado | heygian | status_
┃💫➺ _${usedPrefix}infogian | infobot_
...
┃🎡➺ _${usedPrefix}topgay_
┃🎡➺ _${usedPrefix}toppros_
┃🎡➺ _${usedPrefix}topwapo_
┃🎡➺ _${usedPrefix}topcaca_
┃🎡➺ _${usedPrefix}topragero_
┃🎡➺ _${usedPrefix}topfracasado_
...
┃🎡➺ _${usedPrefix}ragero *nombre : @tag*_
┃🎡➺ _${usedPrefix}goreo *nombre : @tag*_
┃🎡➺ _${usedPrefix}manca *nombre : @tag*_
┃🎡➺ _${usedPrefix}manco *nombre : @tag*_
┃🎡➺ _${usedPrefix}cacanero *nombre : @tag*_
┃🎡➺ _${usedPrefix}pajera *nombre : @tag*_
┃🎡➺ _${usedPrefix}puto *nombre : @tag*_
┃🎡➺ _${usedPrefix}puta *nombre : @tag*_
┃🎡➺ _${usedPrefix}mongol *nombre : @tag*_
...
await conn.sendHydrated2(m.chat, str, wm, pp, 'https://www.facebook.com/gianwalter28', '𝗚𝗜𝗔𝗡-𝗕𝗢𝗧', ig, '𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢', [
['💥 𝘿𝙤𝙣𝙖𝙧 💥', '.donar'],
...
conn.reply(m.chat, `${fg}𝙀𝙍𝙍𝙊𝙍 𝙀𝙉 𝙀𝙇 𝙈𝙀𝙉𝙐, 𝙍𝙀𝙋𝙊𝙍𝙏𝘼 𝘾𝙊𝙉 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 *#report*`, m)
throw e
}}
...
┃🎡➺ _${usedPrefix}gay | gay *@tag*_
┃🎡➺ _${usedPrefix}ragero *nombre : @tag*_
┃🎡➺ _${usedPrefix}gordo *nombre : @tag*_
┃🎡➺ _${usedPrefix}manca *nombre : @tag*_
┃🎡➺ _${usedPrefix}manco *nombre : @tag*_
┃🎡➺ _${usedPrefix}cacanero *nombre : @tag*_
┃🎡➺ _${usedPrefix}pajera *nombre : @tag*_
