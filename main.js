...
const connectionOptions = {
  ...
  browser: ['Gian-Bot','Edge','1.0.0'] //Nombre de la sesión 
}
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.spromote = '*@user 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝙇𝙀𝘿𝙀𝙍 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'
  conn.sdemote = '*@user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙎𝙀𝙍 𝙇𝙀𝘿𝙀𝙍 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'
  conn.sDesc = '*𝙇𝘼 𝙉𝙐𝙀𝙑𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎:*\n@desc'
  conn.sSubject = '*𝘿𝙀𝙅𝘼 𝘿𝙀 𝘾𝘼𝙈𝘽𝙄𝘼𝙍 𝙈𝙄𝙀𝙍𝘿𝘼! 𝙀𝙇 𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎:*\n@subject'
  conn.sIcon = '*𝘼 𝘾𝘼𝘿𝘼 𝙍𝘼𝙏𝙊? 𝙋𝘼𝙑𝙊 𝘾𝙏𝙈!! 𝙎𝙀 𝙃𝘼 𝘾𝘼𝙈𝘽𝙄𝘼𝘿𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊!!'
